          ...
          <div className="trusted">
            ...
            <div className="why-wrapper">
              <div className='why-section'>
                <h2 className='why-h3'>WHY <element className="why-title">MyShop.com</element></h2>
              ...
              <h1 className="comment-title">Why us? Why visit MYShop.com</h1>
              <div className="comment">
                <div className="comment-1">
                  <p>"MYShop.com is an open ERP system. so it's easy to customize as per need. MyShop.com already provides lots of services purchase, inventory which are very useful and easy to handle. From small-scale industries to Multi-National companies you Odoo ERP System.  </p>
                ...
                <div className="comment-1">
                <p>"MyShop.com is super customizable. Anything you would like to be developed is possible and integrations with tons of apps are already made. If you want to integrate new apps,"</p>
